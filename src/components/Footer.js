                ...
                <div className="logo--nav--container">
                    ...
                    <nav className="footer--nav" aria-label="Footer">
                        <ul className="footer--nav--ul" role="menubar">
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!sellOnline ? "Open Sell Online" : "Close Sell Online"} aria-expanded={!sellOnline ? "false" : "true"} onClick={() => setSellOnline(!sellOnline)}>SELL ONLINE <img src={arrow_right} alt="" className={`dropdown ${sellOnline ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!product ? "Open Product" : "Close Product"} aria-expanded={!product ? "false" : "true"} onClick={() => setProduct(!product)}>PRODUCT <img src={arrow_right} alt="" className={`dropdown ${product ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!business ? "Open For Your Business" : "Close For Your Business"} aria-expanded={!business ? "false" : "true"} onClick={() => setBusiness(!business)}>FOR YOUR BUSINESS <img src={arrow_right} alt="" className={`dropdown ${business ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!partners ? "Open Partners" : "Close Partners"} aria-expanded={!partners ? "false" : "true"} onClick={() => setPartners(!partners)}>PARTNERS <img src={arrow_right} alt="" className={`dropdown ${partners ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!company ? "Open Company" : "Close Company"} aria-expanded={!company ? "false" : "true"} onClick={() => setCompany(!company)}>COMPANY <img src={arrow_right} alt="" className={`dropdown ${company ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!support ? "Open Support" : "Close Support"} aria-expanded={!support ? "false" : "true"} onClick={() => setSupport(!support)}>SUPPORT <img src={arrow_right} alt="" className={`dropdown ${support ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!resources ? "Open Resources" : "Close Resources"} aria-expanded={!resources ? "false" : "true"} onClick={() => setResources(!resources)}>RESOURCES <img src={arrow_right} alt="" className={`dropdown ${resources ? "rotate--img" : ""}`}/></span>
                            ...
                            <li role="none">
                                <span role="menuitem" aria-haspopup="true" aria-label={!blog ? "Open Latest Blog" : "Close Latest Blog"} aria-expanded={!blog ? "false" : "true"} onClick={() => setBlog(!blog)}>LATEST BLOG <img src={arrow_right} alt="" className={`dropdown ${blog ? "rotate--img" : ""}`}/></span>
