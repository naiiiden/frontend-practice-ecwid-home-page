...
const Hero = () => {
    return (
        <section className="hero--section">
            ...
            <a href="https://my.ecwid.com/cp/#register" className="hero--link">Get started for free →</a>
            ...
            <div className="hero--ratings--container">
                <figure className="hero--rating">
                    ...
                    <figcaption className="reviewer--opinion">Best ease of use</figcaption>
                </figure>
                <figure className="hero--rating">
                    <img src={trustpilot} alt="trustpilot's review" className="reviewer"/>
                    <figcaption className="reviewer--opinion">4.7 average rating</figcaption>
                </figure>   
                <figure className="hero--rating">
                    <img src={crowd} alt="crowd's review" className="reviewer"/>
                    <figcaption className="reviewer--opinion">Easiest Setup Summer 2021</figcaption>
                </figure>
                <figure className="hero--rating">
                    <img src={crowd} alt="crowd's review" className="reviewer"/>
                    <figcaption className="reviewer--opinion">Best Usability Summer 2021</figcaption>
                </figure>
            </div>
        </section>
    )
